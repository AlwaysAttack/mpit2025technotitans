...
export const viewManagerName = Platform.OS === 'android' ? 'NavViewManager' : 'RCTNavView';
export const sendCommand = (viewId, command, args) => {
  ...
  try {
    ...
    Platform.OS === 'android' ? command.toString() : command, args);
  } catch (exception) {
    console.error(exception);
  }
};
export const commands = UIManager.getViewManagerConfig(viewManagerName).Commands;
